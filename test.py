...
def read_dataset():
    df = pd.read_csv("C:\\Users\\Akshay\\Desktop\\ML\\Tensorflow\\RockVsMine\\sonar_data.csv")
...
X, Y, y1 = read_dataset()
model_path = "C:\\Users\\Akshay\\Desktop\\ML\\Tensorflow\\RockVsMine\\main"
learning_rate = 0.3
...
# print accuracy run
print("************************************************************************")
print(" 0 stands for Mine(M) and 1 stands for Rock(R)")
print("************************************************************************")
